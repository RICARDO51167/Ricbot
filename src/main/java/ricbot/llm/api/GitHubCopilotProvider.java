...
public class GitHubCopilotProvider extends OpenAICompatProvider {
    ...
    protected String getCopilotAccessToken() throws Exception {
        ...
        if (copilotAccessToken != null && now < copilotExpiresAt - GitHubCopilotAuth.EXPIRY_SKEW_SECONDS) {
            return copilotAccessToken;
        }

        GitHubCopilotAuth.OAuthToken githubToken = GitHubCopilotAuth.loadGithubToken();
        ...
        java.net.http.HttpRequest.Builder builder = java.net.http.HttpRequest.newBuilder(
                        java.net.URI.create(GitHubCopilotAuth.DEFAULT_COPILOT_TOKEN_URL))

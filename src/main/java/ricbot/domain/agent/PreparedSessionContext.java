...
record PreparedSessionContext(String sessionKey, Session session, String archivedSummary, TaskState taskStateSnapshot,
                              OutboundMessage immediateResponse, boolean userPersistedEarly) {

    // 构造函数，初始化所有最终字段

    // 创建一个新的上下文实例，仅更新用户提前持久化的标志
    PreparedSessionContext withUserPersistedEarly() {
